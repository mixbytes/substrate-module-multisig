...
use multisig_node_runtime::{self, GenesisConfig, opaque::Block, ClientWithApi};
...
native_executor_instance!(
	pub Executor,
	multisig_node_runtime::api::dispatch,
	multisig_node_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/multisig_node_runtime.compact.wasm")
);
